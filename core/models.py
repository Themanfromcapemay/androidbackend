...
from .constants import RESOURCE_CHOICES, BUILDING_COSTS, ASTROPHYSICS_WORDS, CELESTIAL_WORDS, GREEK_WORDS, \
    TROOP_CHOICES, TROOPS_DATA, PLAYER_CLASS_CHOICES
import random
...
class Planet(models.Model):
    """
    Creates the player's planet, links planet to user. One user
